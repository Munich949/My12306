...
package com.dlnu.index12306.biz.payservice.mq.produce;

import cn.hutool.core.util.StrUtil;
import com.dlnu.index12306.biz.payservice.mq.domain.MessageWrapper;
...
import static com.dlnu.index12306.biz.payservice.common.constant.PayRocketMQConstant.PAY_GLOBAL_TOPIC_KEY;
import static com.dlnu.index12306.biz.payservice.common.constant.PayRocketMQConstant.REFUND_RESULT_CALLBACK_TAG_KEY;
...
public class RefundResultCallbackOrderSendProduce extends AbstractCommonSendProduceTemplate<RefundResultCallbackOrderEvent> {
    ...
    protected BaseSendExtendDTO buildBaseSendExtendParam(RefundResultCallbackOrderEvent messageSendEvent) {
        return BaseSendExtendDTO.builder()
                ...
                .topic(PAY_GLOBAL_TOPIC_KEY)
                .tag(REFUND_RESULT_CALLBACK_TAG_KEY)
                .sentTimeout(2000L)
                .build();
    }
