...
public class UserLoginServiceImpl implements UserLoginService {
    ...
    public UserLoginRespDTO login(UserLoginReqDTO requestParam) {
        ...
        if (userDO != null) {
            ...
            UserLoginRespDTO actual = new UserLoginRespDTO(userInfoDTO.getUserId(), userInfoDTO.getUsername(), userInfoDTO.getRealName(), accessToken);
    ...
    public void deletion(UserDeletionReqDTO requestParam) {
        ...
        RLock lock = redissonClient.getLock(LOCK_USER_DELETION + requestParam.getUsername());
        lock.lock();
        try {
