...
package com.dlnu.index12306.biz.ticketservice.service.handler.ticket.filter.query;
...
import static com.dlnu.index12306.biz.ticketservice.common.constant.RedisKeyConstant.LOCK_QUERY_ALL_REGION_LIST;
import static com.dlnu.index12306.biz.ticketservice.common.constant.RedisKeyConstant.QUERY_ALL_REGION_LIST;
...
public class TrainTicketQueryParamVerifyChainFilter implements TrainTicketQueryChainFilter<TicketPageQueryReqDTO> {
    ...
    public void handler(TicketPageQueryReqDTO requestParam) {
        ...
        // 缓存已经加载过，且 Key 不为空，如果缓存中还不存在出发地或目的地，则证明不存在
