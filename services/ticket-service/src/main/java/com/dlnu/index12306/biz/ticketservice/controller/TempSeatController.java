...
import com.dlnu.index12306.biz.ticketservice.dao.entity.TrainStationRelationDO;
import com.dlnu.index12306.biz.ticketservice.dao.mapper.SeatMapper;
import com.dlnu.index12306.biz.ticketservice.dao.mapper.TrainStationRelationMapper;
import com.dlnu.index12306.framework.starter.cache.DistributedCache;
import com.dlnu.index12306.framework.starter.common.toolkit.ThreadUtil;
...
import static com.dlnu.index12306.biz.ticketservice.common.constant.RedisKeyConstant.TICKET_AVAILABILITY_TOKEN_BUCKET;
import static com.dlnu.index12306.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_STATION_REMAINING_TICKET;

/**
 * 重制列车车票余量临时解决方案，不在主流程中
 */
@Deprecated
@RestController
