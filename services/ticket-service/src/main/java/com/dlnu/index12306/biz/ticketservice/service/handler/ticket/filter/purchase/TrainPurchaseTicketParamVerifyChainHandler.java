...
package com.dlnu.index12306.biz.ticketservice.service.handler.ticket.filter.purchase;

import cn.hutool.core.collection.CollUtil;
import com.alibaba.fastjson2.JSON;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.dlnu.index12306.biz.ticketservice.common.constant.Index12306Constant;
import com.dlnu.index12306.biz.ticketservice.dao.entity.TrainDO;
import com.dlnu.index12306.biz.ticketservice.dao.entity.TrainStationDO;
import com.dlnu.index12306.biz.ticketservice.dao.mapper.TrainMapper;
import com.dlnu.index12306.biz.ticketservice.dao.mapper.TrainStationMapper;
...
import com.dlnu.index12306.framework.starter.common.toolkit.EnvironmentUtil;
...
import static com.dlnu.index12306.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_INFO;
import static com.dlnu.index12306.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_STATION_STOPOVER_DETAIL;

/**
 * 购票流程过滤器之验证参数是否有效
 * 验证参数有效这个流程会大量交互缓存，为了优化性能其实需要使用 Lua。这里使用多次调用缓存
 */
@Component
...
public class TrainPurchaseTicketParamVerifyChainHandler implements TrainPurchaseTicketChainFilter<PurchaseTicketReqDTO> {
    ...
    /**
     * 校验出发站点和目的站点是否存在，且出发站点在目的站点之前
     *
     * @param stationList  车站顺序列表
