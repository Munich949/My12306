package com.dlnu.index12306.framework.starter.designpattern.config;

import com.dlnu.index12306.framework.starter.bases.config.ApplicationBaseAutoConfiguration;
